...
from backend.services.job_deduplication import JobDeduplicationService, find_duplicates_in_db, remove_duplicates
...
DEDUPLICATION_API_KEY = os.getenv("DEDUPLICATION_API_KEY", "default-dedupe-key")
