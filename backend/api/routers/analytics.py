...
ANALYTICS_API_KEY = os.getenv("ANALYTICS_API_KEY", "default-analytics-key")
...
async def get_analytics_metrics(
    ...
    if credentials.credentials != ANALYTICS_API_KEY:
        raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="Invalid analytics API key")
