...
def get_spacy_model():
    ...
    if os.getenv("TEST_ENV") or "pytest" in os.path.basename(os.environ.get("PYTHONPATH", "")) or "pytest" in os.environ.get("PYTEST_CURRENT_TEST", ""):
        logger.info("Skipping spaCy model load in test environment")
        _nlp = None
        return None
        
    try:
        _nlp = spacy.load("en_core_web_sm")  # Use small model instead of large transformer
...
class EnhancedResumeParser:
        ...
        try:
            ...
            for line in lines:
                ...
                if 'experience' in line.lower() or 'work' in line.lower():
                    ...
                    entities["work_experience"].append({"company": orgs[0], "position": line})
    ...
    def extract_skills(text: str) -> List[str]:
        ...
        technical_skills = [
            ...
            "Docker", "Kubernetes", "Git", "HTML", "CSS", "REST", "GraphQL", "API",
            "Machine Learning", "Deep Learning", "NLP", "Computer Vision", "Data Science",
            "TensorFlow", "PyTorch", "Scikit-learn", "Pandas", "NumPy", "Spark",
            "DevOps", "CI/CD", "Jenkins", "GitLab", "AWS Lambda", "Serverless"
        ]
    ...
    def extract_education(text: str) -> List[Dict]:
        ...
        for line in lines:
            ...
            if any(word in line.lower() for word in ["bachelor", "master", "phd", "degree"]):
                current_edu["degree"] = line
            elif any(word in line.lower() for word in ["university", "college", "school"]):
    ...
    async def parse_resume(file_content: bytes, filename: str) -> Dict:
        ...
        try:
            ...
            parsed_data = {
                "full_name": ai_data.get("full_name") or (entities["names"][0] if entities["names"] else None),
