...
class TestApplicationAutomationService:
    ...
    @pytest.mark.asyncio
    @patch('backend.services.application_automation.ApplicationAutomationService.initialize_browser')
    @patch('backend.services.application_automation.ApplicationAutomationService.close_browser')
    @patch('backend.services.application_automation.ApplicationAutomationService.navigate_to_application_page')
    @patch('backend.services.application_automation.ApplicationAutomationService.handle_common_elements')
    @patch('backend.services.application_automation.ApplicationAutomationService.fill_application_form')
    @patch('backend.services.application_automation.ApplicationAutomationService.submit_form')
    @patch('backend.services.application_automation.ApplicationAutomationService.validate_form_submission')
    @patch('backend.services.application_automation.get_db')
    async def test_auto_apply_to_job_success(
        self, mock_get_db,
        mock_validate, mock_submit, mock_fill_form, 
        mock_handle_elements, mock_navigate, mock_close, mock_init
    ):
        ...
        mock_db.query.return_value.filter.return_value.first.side_effect = [mock_job, mock_user, mock_profile]
    ...
    async def test_auto_apply_exception(
        self, mock_get_db,
        mock_navigate, mock_close, mock_init
    ):
