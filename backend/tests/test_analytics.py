...
class TestAnalyticsService:
    ...
    def test_classify_job_type(self):
        ...
        assert (
            service._classify_job_type("Frontend Developer") == "Software Development"
        )
        assert (
            service._classify_job_type("Full Stack Engineer") == "Software Development"
        )
    ...
    def test_export_report_json(self, mock_analytics):
        ...
        mock_analytics.export_report.return_value = (
