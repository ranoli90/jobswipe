    ...
    for attempt in range(max_attempts):
        try:
            ...
            if client.is_authenticated():
                ...
                print(f"Vault authentication failed (attempt {attempt + 1}/{max_attempts})")
        except Exception as e:
            print(f"Vault connection failed (attempt {attempt + 1}/{max_attempts}): {e}")
