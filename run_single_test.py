    ...
    with patch('backend.services.job_ingestion_service.JobIngestionService.ingest_greenhouse_jobs') as mock_ingest_greenhouse, \
        ...
        try:
            ...
            if mock_ingest_greenhouse.called:
                print(f"✅ Assertion passed: mock_ingest_greenhouse called {mock_ingest_greenhouse.call_count} times")
            else:
                print("❌ Assertion failed: mock_ingest_greenhouse not called")
                
            if mock_ingest_lever.called:
                print(f"✅ Assertion passed: mock_ingest_lever called {mock_ingest_lever.call_count} times")
            else:
