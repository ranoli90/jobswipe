class ApiEndpoints {
  // Base URL is configured in Dio via AppConfig.baseUrl
  // AppConfig.baseUrl already includes /api suffix
  ...
  static const String getJobFeed = '/v1/feed';
  static const String getJobDetails = '/v1/{id}';
  static const String getJobMatches = '/v1/matches';
  static const String swipeJob = '/v1/{id}/swipe';
